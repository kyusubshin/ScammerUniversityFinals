...
OUTPUT_FILE_PATH = "../artifacts/claude_results.csv"
NUM_ROUNDS = 50
load_dotenv()
...
MODEL_NAME = "claude-haiku-4-5-20251001" # Example model, can be changed
...
def call_claude():
    ...
    requesting the answer for each question from the Claude model,
